...
FileServiceImpl implements FileService {
    ResultVo resultVo;
    @Override
    public ResultVo file(MultipartFile file) {
        // 上传的路径
        String path = "D:/server/apache-tomcat-8.5.37/webapps/upload/Poverty-Alleviation/";
...
//            System.out.println(vo.getData());
            ...
            map.put("imgurl", "http://localhost:8081/upload/Poverty-Alleviation/" + "/" + filename);
